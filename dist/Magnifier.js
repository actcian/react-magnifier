...
var Magnifier = function (props) {
    ...
    var _a = React.useState(false), showZoom = _a[0], setShowZoom = _a[1];
    var _b = React.useState(0), mgOffsetX = _b[0], setMgOffsetX = _b[1];
    var _c = React.useState(0), mgOffsetY = _c[0], setMgOffsetY = _c[1];
    var _d = React.useState(0), relX = _d[0], setRelX = _d[1];
    var _e = React.useState(0), relY = _e[0], setRelY = _e[1];
    var imgRef = React.useRef(null);
    var _f = React.useState(null), imgBounds = _f[0], setImgBounds = _f[1];
    ...
    return (React__default.createElement("div", { className: "magnifier ".concat(className), style: {
            width: width,
            height: height,
            overflow: mgShowOverflow ? "visible" : "hidden",
        } },
        React__default.createElement("img", { className: "magnifier-image", src: src, width: "100%", height: "100%", onLoad: calcImgBounds, ref: imgRef }),
        imgBounds && (React__default.createElement("div", { className: "magnifying-glass ".concat(showZoom ? "visible" : "", " ").concat(mgShape), style: {
                width: mgWidth,
                height: mgHeight,
